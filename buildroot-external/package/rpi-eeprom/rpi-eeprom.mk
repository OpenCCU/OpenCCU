...
RPI_EEPROM_VERSION = 77b5368159e21241b35549659e5af4cb3d18aaeb
...
ifeq ($(BR2_PACKAGE_RPI_EEPROM_RPI4),y)
  # Raspberry Pi 4 (2711)
  RPI_EEPROM_FIRMWARE_PATH = firmware-2711/stable/pieeprom-2026-05-17.bin
  ...
  # Raspberry Pi 5 (2712)
  RPI_EEPROM_FIRMWARE_PATH = firmware-2712/stable/pieeprom-2026-05-17.bin
