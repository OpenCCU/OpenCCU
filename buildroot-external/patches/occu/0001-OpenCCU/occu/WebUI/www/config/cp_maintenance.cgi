                  ...
                  table {
                    table_row {
                      table_data {
                        ...
                        division {class="CLASS20908"}  "onClick=\"window.open('https://github.com/homematicip/openccu-lts/releases/latest','_blank');\"" {puts "\${dialogSettingsCMBtnPerformSoftwareUpdateDownload}"}
                      }
                    }
                  }
                }
