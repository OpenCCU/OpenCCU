...
<sub>📦 [OpenCCU-LTS-${VERSION}-ccu3.tgz](https://github.com/OpenCCU/OpenCCU/releases/download/${VERSION}/OpenCCU-LTS-${VERSION}-ccu3.tgz) **(only for initial CCU3 Firmware -> OpenCCU Upgrade)**<br/> SHA256: XSHAccu3.tgzX</sub>
<sub>📦 [OpenCCU-LTS-${VERSION}-rpi3.zip](https://github.com/OpenCCU/OpenCCU/releases/download/${VERSION}/OpenCCU-LTS-${VERSION}-rpi3.zip)<br/>SHA256: XSHArpi3.zipX</sub>
