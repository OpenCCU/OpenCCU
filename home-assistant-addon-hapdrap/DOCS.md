...
| `openccu_mac` | No | Static MAC address used for the OpenCCU app macvlan interface. If empty, the helper derives a stable locally administered MAC from the parent interface. |
